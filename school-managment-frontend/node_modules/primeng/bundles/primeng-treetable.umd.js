(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('rxjs'), require('primeng/dom'), require('primeng/paginator'), require('primeng/api'), require('primeng/utils')) :
    typeof define === 'function' && define.amd ? define('primeng/treetable', ['exports', '@angular/core', '@angular/common', 'rxjs', 'primeng/dom', 'primeng/paginator', 'primeng/api', 'primeng/utils'], factory) :
    (global = global || self, factory((global.primeng = global.primeng || {}, global.primeng.treetable = {}), global.ng.core, global.ng.common, global.rxjs, global.primeng.dom, global.primeng.paginator, global.primeng.api, global.primeng.utils));
}(this, (function (exports, core, common, rxjs, dom, paginator, api, utils) { 'use strict';
                    ...
                    if (nextColumn) {
                        ...
                        if (newColumnWidth > 15 && nextColumnWidth > parseInt(nextColumnMinWidth)) {
                            if (this.scrollable) {
                                ...
                                var scrollableBodyTable = dom.DomHandler.findSingle(scrollableView, 'table.ui-treetable-scrollable-body-table');
    ...
    var TTScrollableView = /** @class */ (function () {
        ...
        TTScrollableView.prototype.ngAfterViewInit = function () {
            ...
            if (!this.frozen) {
                ...
                this.scrollBodyViewChild.nativeElement.style.paddingBottom = dom.DomHandler.calculateScrollbarWidth() + 'px';
            }
            if (this.tt.virtualScroll) {
        ...
        TTScrollableView.prototype.onBodyScroll = function (event) {
            ...
            if (this.tt.virtualScroll) {
                var viewport = dom.DomHandler.getOuterHeight(this.scrollBodyViewChild.nativeElement);
                var tableHeight = dom.DomHandler.getOuterHeight(this.scrollTableViewChild.nativeElement);
                var pageHeight_1 = this.tt.virtualRowHeight * this.tt.rows;
                var virtualTableHeight = dom.DomHandler.getOuterHeight(this.virtualScrollerViewChild.nativeElement);
        ...
        TTScrollableView.prototype.setScrollHeight = function () {
            if (this.scrollHeight && this.scrollBodyViewChild && this.scrollBodyViewChild.nativeElement) {
                if (this.scrollHeight.indexOf('%') !== -1) {
                    ...
                    var containerHeight = dom.DomHandler.getOuterHeight(this.tt.el.nativeElement.children[0]);
                    if (this.scrollHeight.includes("calc")) {
                        ...
                        relativeHeight = (dom.DomHandler.getOuterHeight(this.tt.el.nativeElement.parentElement) * percentHeight / 100) - diffValue;
                    }
                    else {
                        relativeHeight = dom.DomHandler.getOuterHeight(this.tt.el.nativeElement.parentElement) * parseInt(this.scrollHeight) / 100;
                    }
                    ...
                    if (this.frozen)
                        this.scrollBodyViewChild.nativeElement.style.maxHeight = (parseInt(this.scrollHeight) - dom.DomHandler.calculateScrollbarWidth()) + 'px';
                    else
        ...
        __decorate([
            core.ViewChild('scrollFooter', { static: true })
        ], TTScrollableView.prototype, "scrollFooterViewChild", void 0);
        __decorate([
            core.ViewChild('scrollFooterBox', { static: true })
    ...
    var TreeTableModule = /** @class */ (function () {
        ...
        TreeTableModule = __decorate([
            core.NgModule({
                ...
                exports: [TreeTable, api.SharedModule, TreeTableToggler, TTSortableColumn, TTSortIcon, TTResizableColumn, TTRow, TTReorderableColumn, TTSelectableRow, TTSelectableRowDblClick, TTContextMenuRow, TTCheckbox, TTHeaderCheckbox, TTEditableColumn, TreeTableCellEditor],
