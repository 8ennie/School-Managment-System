...
function DataView_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassMap("ui-dataview-loading-icon pi-spin " + ctx_r342.loadingIcon);
} }
function DataView_p_paginator_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_5_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r349); const ctx_r348 = ɵngcc0.ɵɵnextContext(); return ctx_r348.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r343 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r343.rows)("first", ctx_r343.first)("totalRecords", ctx_r343.totalRecords)("pageLinkSize", ctx_r343.pageLinks)("alwaysShow", ctx_r343.alwaysShowPaginator)("rowsPerPageOptions", ctx_r343.rowsPerPageOptions)("dropdownAppendTo", ctx_r343.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r343.paginatorDropdownScrollHeight)("templateLeft", ctx_r343.paginatorLeftTemplate)("templateRight", ctx_r343.paginatorRightTemplate)("currentPageReportTemplate", ctx_r343.currentPageReportTemplate)("showCurrentPageReport", ctx_r343.showCurrentPageReport);
} }
...
function DataView_ng_template_8_Template(rf, ctx) { if (rf & 1) {
    ...
    const rowData_r350 = ctx.$implicit;
    const rowIndex_r351 = ctx.index;
    const ctx_r344 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r344.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(2, _c0, rowData_r350, rowIndex_r351));
} }
function DataView_div_10_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r345.emptyMessage);
} }
function DataView_p_paginator_11_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_11_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r354); const ctx_r353 = ɵngcc0.ɵɵnextContext(); return ctx_r353.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r346 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r346.rows)("first", ctx_r346.first)("totalRecords", ctx_r346.totalRecords)("pageLinkSize", ctx_r346.pageLinks)("alwaysShow", ctx_r346.alwaysShowPaginator)("rowsPerPageOptions", ctx_r346.rowsPerPageOptions)("dropdownAppendTo", ctx_r346.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r346.paginatorDropdownScrollHeight)("templateLeft", ctx_r346.paginatorLeftTemplate)("templateRight", ctx_r346.paginatorRightTemplate)("currentPageReportTemplate", ctx_r346.currentPageReportTemplate)("showCurrentPageReport", ctx_r346.showCurrentPageReport);
} }
